...
<canvas
	class="canva-agua-bosque-custom"
	{width}
	{height}
	style:background
	bind:this={canvas}
...
<style>
	:global(.canva-agua-bosque-custom) {
		border: 1px solid #ced4da;
		border-radius: 0.375rem;
		touch-action: none;

		background-image: url('/images/bomberos.jpeg') !important;
		background-size: contain !important; /* Para asegurarse de que la imagen no se agrande más allá de su tamaño original */
		background-repeat: no-repeat !important;
		background-position: center center !important; /* Centra la imagen tanto horizontal como verticalmente */
	}
</style>
