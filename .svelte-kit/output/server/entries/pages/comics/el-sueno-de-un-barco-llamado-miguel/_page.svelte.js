...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css);
  return `${$$result.head += `<!-- HEAD_svelte-xvbk8s_START -->${$$result.title = `<title>El barrigón</title>`, ""}<meta name="El barrigón." content="QUIZ 1 | GRADO 4°"><!-- HEAD_svelte-xvbk8s_END -->`, ""} <section><div class="container"><div class="row row-cols-auto align-items-center text-left"><div class="embed-responsive">${validate_component(missing_component, "svelte:component").$$render(
    $$result,
    {
      url: "/pdf/El sueño de un barco llamado Miguel.pdf",
